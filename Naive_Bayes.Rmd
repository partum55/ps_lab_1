...
build_preprocessing_pipeline <- function(texts,
  ...
  # Create sparse matrix - handle empty case
  if (length(doc_indices) == 0) {
    # Create empty matrix if no terms found
    dtm <- Matrix::Matrix(0,
...
naiveBayes <- setRefClass("naiveBayes",
  ...
  methods = list(
    ...
    predict = function(message) {
      ...
      scores_mat <- as.matrix(dtm_aligned %*% model$log_likelihoods)
...
test_message <- "Free money! Call now!"
